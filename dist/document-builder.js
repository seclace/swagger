...
class DocumentBuilder {
    ...
    addBearerAuth(name = 'Authorization', location = 'header', type = 'apiKey') {
        this.document.securityDefinitions = Object.assign(Object.assign({}, (this.document.securityDefinitions || {})), { bearer: {
                type,
                name,
                in: location
            } });
    ...
    addOAuth2(flow = 'password', authorizationUrl, tokenUrl, scopes) {
        this.document.securityDefinitions = Object.assign(Object.assign({}, (this.document.securityDefinitions || {})), { oauth2: {
                type: 'oauth2',
                flow,
                authorizationUrl,
                tokenUrl,
