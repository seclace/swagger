...
class SwaggerScanner {
    ...
    scanApplication(app, includedModules, deepScanRoutes) {
        ...
        return Object.assign(Object.assign({}, this.transfomer.normalizePaths(lodash_1.flatten(denormalizedPaths))), { definitions: lodash_1.reduce(this.explorer.getModelsDefinitons(), lodash_1.extend) });
    }
